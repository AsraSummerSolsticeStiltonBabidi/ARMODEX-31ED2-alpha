...
const html = fs.readFileSync('/sessions/modest-gallant-cray/mnt/outputs/ecosystem.html', 'utf8');
const scriptMatch = html.match(/<script>([\s\S]*?)<\/script>/);
if(!scriptMatch) throw new Error('could not find <script> block in ecosystem.html');
